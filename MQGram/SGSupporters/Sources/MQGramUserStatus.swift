...
// MARK: - MQGram check_user response models

public struct MQGramUserStatus: Equatable {
    public let userId: String
    public let badges: [MQGramBadge]
    public let subscription: MQGramSubscription?
    public let trial: MQGramTrial?
    public let donation: MQGramDonation?
    public let access: MQGramAccess
    public let mqgramPromo: MQGramPromo?
    public let betaConfig: MQGramBetaConfig?
    ...
    public init(json: [String: Any]) {
        ...
        self.badges = (json["badges"] as? [[String: Any]] ?? []).compactMap { MQGramBadge(json: $0) }
        self.subscription = (json["subscription"] as? [String: Any]).flatMap { MQGramSubscription(json: $0) }
        self.trial = (json["trial"] as? [String: Any]).flatMap { MQGramTrial(json: $0) }
        self.donation = (json["donation"] as? [String: Any]).flatMap { MQGramDonation(json: $0) }
        self.access = MQGramAccess(json: json["access"] as? [String: Any] ?? [:])
        self.mqgramPromo = (json["mqgramPromo"] as? [String: Any]).flatMap { MQGramPromo(json: $0) }
        self.betaConfig = (json["betaConfig"] as? [String: Any]).flatMap { MQGramBetaConfig(json: $0) }
...
public struct MQGramBadge: Equatable {
    ...
    public let uiConfig: MQGramBadgeUIConfig?
    ...
    public init?(json: [String: Any]) {
        ...
        self.uiConfig = (json["uiConfig"] as? [String: Any]).flatMap { MQGramBadgeUIConfig(json: $0) }
    }
}

public struct MQGramBadgeUIConfig: Equatable {
    public let title: String
    public let description: String
    public let buttons: [MQGramBadgeButton]

    public init?(json: [String: Any]) {
        self.title = json["title"] as? String ?? ""
        self.description = json["description"] as? String ?? ""
        self.buttons = (json["buttons"] as? [[String: Any]] ?? []).compactMap { MQGramBadgeButton(json: $0) }
    }
}

public struct MQGramBadgeButton: Equatable {
...
public struct MQGramSubscription: Equatable {
...
public struct MQGramTrial: Equatable {
    public let startedAt: String
    public let expiresAt: String
    public let active: Bool
...
public struct MQGramDonation: Equatable {
...
public struct MQGramAccess: Equatable {
    ...
    public init(json: [String: Any]) {
        let tab = json["mqgramTab"] as? Bool ?? false
    ...
    public static func == (lhs: MQGramAccess, rhs: MQGramAccess) -> Bool {
        return lhs.mqgramTab == rhs.mqgramTab && lhs.betaBuilds == rhs.betaBuilds
    }
}

public struct MQGramPromo: Equatable {
    public let title: String
...
public struct MQGramBetaConfig: Equatable {
...
extension MQGramUserStatus {
    public func toJSON() -> [String: Any] {
        ...
        if let p = mqgramPromo { dict["mqgramPromo"] = p.toJSON() }
        if let b = betaConfig { dict["betaConfig"] = b.toJSON() }
        return dict
    }
}

extension MQGramBadge {
