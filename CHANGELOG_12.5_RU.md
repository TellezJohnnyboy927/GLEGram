# MQGram 12.5 — Что нового

---

## Обновление до Telegram 12.5

Полный переход на новую базу Telegram iOS 12.5. Все функции MQGram сохранены и работают на актуальной версии.
...
- Новая иконка MQGram по умолчанию (Dark Purple)
...
Дата окончания подписки теперь отображается рядом с пунктом MQGram в настройках. Кнопка оформления подписки ведёт в чат поддержки @glesign_support.
