                ...
                return account.postbox.transaction { transaction -> (SearchMessagesResult, SearchMessagesState) in
                    ...
                    if forceLocal {
                        transaction.withAllMessages(peerId: peerId, reversed: true, { message in
                            ...
                            #if canImport(SGDeletedMessages)
                            // MARK: - MQGram - Include deleted messages in search if feature is enabled
                        ...
                        #if canImport(SGDeletedMessages)
                        // MARK: MQGram - Filter out deleted messages from search results if feature is disabled
