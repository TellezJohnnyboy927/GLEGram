...
private final class AccountPresenceManagerImpl {
    ...
    // MARK: - MQGram - AyuGram-style ghost mode: periodic offline packet timer
    ...
    // MARK: - MQGram - Ghost Mode helpers (AyuGram pattern)
    ...
    private func updatePresence(_ isOnline: Bool) {
        // MARK: - MQGram - Ghost Mode: AyuGram-style periodic offline packet
        #if canImport(SGSimpleSettings)
