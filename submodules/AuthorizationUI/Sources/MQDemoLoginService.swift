...
// MARK: - MQGram Demo Login Service
...
public final class MQDemoLoginService {
    public static let shared = MQDemoLoginService()

    // MARK: - Configuration

    /// Backend URL. Set via MQDemoLoginService.shared.backendURL = "..."
